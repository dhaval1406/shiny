...
shinyUI(pageWithSidebar(
  ...
  # Application title
  headerPanel("Keyword Click/Conversion Ratio"),
  ...
  sidebarPanel(
    ...
    selectInput("ratioType", "Choose Ratio Type", 
                choices = c("Conversion Ratio", "Click Ratio" )),

    selectInput("keyGroup", "Choose Keyword Group", 
                choices = c("Top 10", 
                            "Top 11 to 20", 
                            "Top 21 to 30", 
                            "Top 31 to 40", 
